...
def parse_status(homework):
    ...
    if 'homework_name' not in homework:
        logger.error('This key is not valid')
...
def check_tokens():
    ...
    if (TELEGRAM_TOKEN is None and
        PRACTICUM_TOKEN is None and
